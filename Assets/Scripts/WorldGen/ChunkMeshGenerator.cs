...
namespace MeshGen
{
    public class ChunkMeshGenerator
    {
        ...
        //public Mesh GenerateMeshThreaded(Chunk chunkModel)
        //{
        //    ThreadPool.QueueUserWorkItem(new WaitCallback(ThreadableMeshGen), chunkModel);
        //    //Thread thread = new Thread(new ParameterizedThreadStart(ThreadableMeshGen));
        //    //thread.Start(chunkModel);
        //    //thread.Join();
        //    return ResultMesh;
        //}

        //public void ThreadableMeshGen(object chunk)
        //{
        //    Chunk chunkModel = (Chunk)chunk;
        //    int vertCount = 0;
        //    int trianglesCount = 0;
        //    for (int z = 0; z < chunkModel.Zsize; z++)
        //    {
